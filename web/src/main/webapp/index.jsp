...
<div class="flashImg">
    ...
    <div class="registerBody">
        ...
        <div class="register">
            <h3>动力金融网历史年化收益率</h3>
            <h4><span id="avg">$${historyAvgRate}</span>%</h4>
...
<div class="brand-promotion">
    ...
    <div class="mainBox">
        ...
        <div class="jinxin-data">
            <h3>平台用户数</h3>
            <div class="data"><span id="hzxx_ljrs">${totalUserCount}</span>位</div>
            <div class="line"></div>
            <h3>累计成交额</h3>
            <div class="data"><span id="hzxx_ljje">${totalBidAmount}</span>元</div>
        </div>
    </div>
</div>
<!--品牌宣传end-->
...
<div id="productArea">
	<!--新手宝 begin-->
	<c:forEach items="${xinLoanInfos}" var="xinLoan">
	<div class="index-exper">
     <div class="inner">
          <div class="index-exper-top">
               <span class="title"><font style="font-size:28px;">新手宝</font></span>
               <p class="text">${xinLoan.bidMinLimit}元起投<em>丨
               </em>投资最高限额${xinLoan.bidMaxLimit}元<em>丨</em>当日计息</p>
          </div>
          <div class="index-exper-bottom">
               <ul class="list cf">
                   <li class="box1">
                       <p class="text1">${xinLoan.rate}<span>%</span></p>
                       <p class="text2">历史年化收益率</p>
                   </li>
                   <li class="box2">
                       <p class="text1">${xinLoan.cycle}<span>天</span></p>
                       <p class="text2">投资周期</p>
                   </li>
                   <li class="box3">
                       <p class="text1">${xinLoan.leftProductMoney}<span>元</span></p>
	...
	<!-- 优选计划start -->
	<c:forEach items="${youLoanInfos}" var="youLoan">
	<div class="mainBox pro-body clearfix">

        <c:forEach items="${youLoanInfos}" var="youLoan">
            <!-- 1:已满标时class样式追加 pro-full-->
            <div class="pro-box ${youLoan.productStatus != 0 ? 'pro-full' : ''}">
			<div class="pro-top">
				<h3>满月宝</h3>
				<p>短期小额信用借款集合投资计划</p>
			</div>
			<div class="pro-main">
				...
				<div class="pro-data clearfix">
					<div class="pro-cycle">
						<h3>投资周期</h3>
						<div class="data"><span>${youLoan.cycle}</span>个月</div>
					</div>
					<div class="pro-money">
						<h3>剩余可投金额</h3>
						<div class="data">
							<span>${youLoan.leftProductMoney}</span>元
						</div>
					</div>
				</div>
	...
	<div class="mainBox pro-body disperse-pro clearfix">
        ...
        <c:forEach items="${sanLoanInfos}" var="sanLoan" varStatus="vs">
		<!-- 1:已满标时追加pro-full-->
		<div class="pro-box" ${sanLoan.productStatus != 0 ?'pro-full':''}>
			<div class="pro-top">
				<h3>个人信用消费借款</h3>
				<p>动力金融网特选小额理财产品</p>
			</div>
			<div class="pro-main">
				<div class="pro-rate">
					<div class="rate">${sanLoan.rate}<span>%</span></div>
					<h3>历史年化收益率</h3>
				</div>
				<div class="pro-data clearfix">
					<div class="pro-cycle">
						<h3>投资周期</h3>
						<div class="data"><span>${sanLoan.cycle}</span>个月</div>
					</div>
					<div class="pro-money">
						<h3>剩余可投金额</h3>
						<div class="data">
							<span>${sanLoan.leftProductMoney}</span>元
						</div>
					</div>
				</div>
				<div class="pro-btn">     
